...
PATH_TO_LABELS = "E:\\TensorFlow\\workspace\\training_demo\\annotations\\label_map.pbtxt"
...
def manual_label_video(video_file, outLabel):
    ...
    while cap.isOpened():
        ...
        # frame_resized = cv2.resize(frame_rgb, (512, 512))  # Resize image to match model's expected sizing

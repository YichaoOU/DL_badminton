...
# python exporter_main_v2.py --input_type image_tensor --pipeline_config_path models\resnet\pipeline.config --trained_checkpoint_dir models\resnet\ --output_directory exported-models-resnet 